...
-- POST /rest/v1/rpc/forgot_password
-- Body: { "p_phone": "9677xxxxxxxx" }
-- -------------------------------------------------------
...
-- POST /rest/v1/rpc/change_my_password
-- Body: { "p_new_password": "كلمةالسرالجديدة" }
-- -------------------------------------------------------
...
-- -------------------------------------------------------
-- ADMIN RESET USER PASSWORD (returns the new password)
-- POST /rest/v1/rpc/admin_reset_user_password
-- Body: { "p_phone": "9677xxxxxxxx" }
-- -------------------------------------------------------
...
BEGIN
  ...
  PERFORM net.http_post(
    url     := 'https://www.traccar.org/sms/',
    headers := jsonb_build_object('Authorization', v_token, 'Content-Type', 'application/json'),
    body    := jsonb_build_object(
      'to',      p_phone,
